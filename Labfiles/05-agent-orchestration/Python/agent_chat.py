...
async def main():
    ...
    async with (
        ...
        # Retrieve the existing incident manager agent from the Azure AI agent service
        # incident_agent_definition = await client.agents.get_agent(name=INCIDENT_MANAGER)
